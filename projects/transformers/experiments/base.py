...
transformers_base = dict(
    ...
    # Model arguments
    cache_dir="/home/tangyu/nupic.research/results/pretrained-models/huggingface",
    # tokenized_data_cache_dir="/home/tangyu/nupic.research/results/preprocessed-datasets/text",
