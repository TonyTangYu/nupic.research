...
hp_search_finetuning_trifecta_80_100k_small_tasks.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_80%_trifecta_100k"  # noqa
)

hp_search_finetuning_trifecta_90_100k_small_tasks = deepcopy(
    hp_search_finetuning_trifecta_85_100k_small_tasks)
hp_search_finetuning_trifecta_90_100k_small_tasks.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_90%_trifecta_100k"  # noqa
)
...
hp_search_finetuning_bert_100k_small_tasks.update(
    model_type="bert",
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_100k",  # noqa
...
hp_search_finetuning_trifecta_2x_small_tasks.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_2x_trifecta_100k"  # noqa
)
...
hp_search_finetuning_trifecta_85_100k_big_tasks = deepcopy(
    hp_search_finetuning_trifecta_85_100k_big_tasks)
hp_search_finetuning_trifecta_85_100k_big_tasks.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_8%_trifecta_100k"  # noqa
)
