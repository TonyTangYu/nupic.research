...
finetuning_tiny_bert_trifecta_100k.update(
    # Model arguments
    model_type="fully_static_sparse_bert",
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/tiny_bert_trifecta_100k",  # noqa: E501
    trainer_callbacks=[
        RezeroWeightsCallback(),
        TrackEvalMetrics(),
    ],
...
small_bert_dataset_args = dict(
    ...
    tokenized_data_cache_dir="/home/tangyu/nupic.research/huggingface/preprocessed-datasets/text",  # noqa: E501
)
...
finetuning_small_bert_trifecta_100k_glue.update(
    # Model arguments
    model_type="fully_static_sparse_bert",
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/small_bert_80%_trifecta_100k",  # noqa: E501
    trainer_callbacks=[
        TrackEvalMetrics(),
        RezeroWeightsCallback()],
    rm_checkpoints=True,
...
finetuning_small_bert_sparse_85_trifecta_100k_glue.update(
    # Model arguments
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/small_bert_85%_trifecta_100k",  # noqa: E501
)
...
finetuning_small_bert_sparse_90_trifecta_100k_glue.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/small_bert_90%_trifecta_100k"  # noqa: E501
)
...
finetuning_small_bert_sparse_2x_trifecta_100k_glue.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/small_bert_2x_trifecta_100k"  # noqa: E501
)
...
finetuning_small_bert_sparse_4x_trifecta_100k_glue.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/small_bert_4x_trifecta_100k"  # noqa: E501
)
...
squad_trifecta_85_100k.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_85%_trifecta_100k"  # noqa: E501
)

squad_trifecta_90_100k = deepcopy(bert_100k_squad)
squad_trifecta_90_100k.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_90%_trifecta_100k"  # noqa: E501
)

squad_trifecta_2x_100k = deepcopy(bert_100k_squad)
squad_trifecta_2x_100k.update(
    model_name_or_path="/home/tangyu/nupic.research/results/pretrained-models/transformers-local/bert_sparse_2x_trifecta_100k",  # noqa: E501
)
